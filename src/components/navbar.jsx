...
function Navbar() {
return <nav className="bg-green-800 p-4 text-white flex justify-between items-center"><span className="text-2xl font-bold tracking-wide">🕌 Nimrah Education and Community Center</span>
